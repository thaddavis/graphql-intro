...
class DiscriminatorTypeComposer extends graphql_compose_1.ObjectTypeComposer {
    ...
    static createFromModel(baseModel, schemaComposer, opts) {
        ...
        const baseTC = composeWithMongoose_1.composeWithMongoose(baseModel, opts);
        ...
        reorderFields_1.reorderFields(baseDTC, baseDTC.opts.reorderFields, baseDTC.discriminatorKey);
        baseDTC.schemaComposer.addSchemaMustHaveType(baseDTC);
        prepareBaseResolvers_1.prepareBaseResolvers(baseDTC);
        return baseDTC;
    }
    ...
    discriminator(childModel, opts) {
        const customizationOpts = mergeCustomizationOptions_1.mergeCustomizationOptions(this.opts, opts);
        let childTC = composeWithMongoose_1.composeWithMongoose(childModel, customizationOpts);
        childTC = composeChildTC_1.composeChildTC(this, childTC, this.opts);
    ...
    setFields(fields) {
        ...
        for (const childTC of this.childTCs) {
            ...
            reorderFields_1.reorderFields(childTC, this.opts.reorderFields, this.getDKey(), super.getFieldNames());
        }
        return this;
    }
