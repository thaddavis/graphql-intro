...
function embeddedToGraphQL(field, prefix = '', schemaComposer) {
    ...
    const typeName = `${prefix}${graphql_compose_1.upperFirst(fieldName)}`;
...
function enumToGraphQL(field, prefix = '', schemaComposer) {
    ...
    const typeName = `Enum${prefix}${graphql_compose_1.upperFirst(_getFieldName(field))}`;
...
function documentArrayToGraphQL(field, prefix = '', schemaComposer) {
    ...
    const typeName = `${prefix}${graphql_compose_1.upperFirst(_getFieldName(field))}`;
